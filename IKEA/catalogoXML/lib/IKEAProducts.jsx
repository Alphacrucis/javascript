...
var IKEA = (function(){
    const IKEA_URL = "http://taggerservices.ikeasi.com/esi/es/catalog/products/"
    // http://ibiza.ikea.es/esi/es/catalog/products/";
    const IKEA_URL_IMG = "http://s3-eu-west-1.amazonaws.com/ikeasiwebimages/imagenes_articulosweb/";
    const IMG_URL_TOKEN = "URL_FOTOS";

    var img_url = function(imgstr) { 
        return imgstr.replace(IMG_URL_TOKEN, IKEA_URL_IMG);
    }
    ...
    var _GET = function (url, params){
        ...
        alert('Error al conectar con la URL ' + url + ' con error ' + response.status);
    };
    ...
    var getProductInfoJSON = function(partNumbers, island, date){
        ...
        alert('Error al conectar con la URL de la base de datos.');
    };
    ...
    var exported = {
        ...
        ORIGENES: [ 
             ...
             { name: 'SANTO DOMINGO',code: "stodomingo" }, 
        ...
        CF_AREA           : "area",             CL_AREA           : "çrea",                   CP_AREA            : -1,
        ...
        CF_CUSTBENEFIT    : "custbenefit",      CL_CUSTBENEFIT    : "Informaci—n",            CP_CUSTBENEFIT     : 07,
        ...
        CF_DESIGNER       : "designer",         CL_DESIGNER       : "Dise–ador",              CP_DESIGNER        : 08,
        CF_ENVIRONMENT    : "environment",      CL_ENVIRONMENT    : "Medio Ambiente",         CP_ENVIRONMENT     : -1,
        CF_FACTS          : "facts",            CL_FACTS          : "Descripci—n",            CP_FACTS           : 01,
        CF_FORMATNUMBER   : "formatnumber",     CL_FORMATNUMBER   : "C—digo",                 CP_FORMATNUMBER    : 09,
        ...
        CF_MEASURE        : "measure",          CL_MEASURE        : "Tama–o",                 CP_MEASURE         : 03,
        CF_NAME           : "name",             CL_NAME           : "Art’culo",               CP_NAME            : 00,
        CF_PACKAGE        : "package",          CL_PACKAGE        : "Empaquetado",            CP_PACKAGE         : -1,
        CF_PARTNUMBER     : "partnumber",       CL_PARTNUMBER     : "C—digo",                 CP_PARTNUMBER      : -1,
        ...
        CF_SUBITEMQUANTITY: "subitemquantity",  CL_SUBITEMQUANTITY: "Nœmero de componentes",  CP_SUBITEMQUANTITY : -1,
        ...
        RE_PRICE: /\uFEFF*\$.+?(?: |$)|\b\uFEFF*RD\$.+?(?: |$)|\Û\uFEFF*\d+/gm,


        /** Cachea el s’mbolo de monea o devuelve el
            œltimo valor cacheado */
        ...
        price_symbol: function(ps) {
            if (!!ps) {
                ...
                return this.cached_price_symbol || 'Û';
        },
            ...
            return {
                ...
                get: function(field, options) { 
                    ...
                    */
                    ...
                    var v = this.attributes[field.toLowerCase()] ||Êthis.attributes[IKEA[field]];
                ...
                getImage: function() {
                    if (!this._cached_image) {
                        this._cached_image = _GET(img_url(this.attributes[IKEA.CF_IMAGE]));
                        // this._cached_image = curl(img_url(this.attributes[IKEA.CF_IMAGE]));
                    }
...
//                throw ErrorValidacion('No se han encontrado datos para la referencia ' + partNumbers);
            ...
            for (var ix=0, ex=products_.length; ix<ex; ++ix) {
                if (!products_[ix].get(IKEA.CF_FORMATNUMBER)){
                    throw { name: "Error de par‡metro", message:"El producto obtenido no tiene un c—digo v‡lido", 
        ...
        partNumber: function(pn) {
            ...
            throw new TypeError('ERROR: "' + pn + '" no es un c—digo de articulo v‡lido');
        },
        ...
        getSource: function(source) {
            ...
            throw ErrorValidacion('No se ha indicado el origen de los datos de art’culo');
        },
    };
